      ...
      <Container>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link href="https://twitter.com/aierdotapp" className="group" aria-label="AIer on Twitter">
            ...
            <Link href="https://github.com/aierdotapp" className="group" aria-label="AIer on GitHub">
              <svg aria-hidden="true" className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} AIer. All rights reserved.
          </p>
        </div>
      </Container>
    </footer>
